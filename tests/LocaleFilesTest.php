...
/**
 * @file plugins/generic/authorContributorEditor/tests/LocaleFilesTest.php
 *
...
class LocaleFilesTest extends PKPTestCase
{
    ...
    public function testEveryKeyTheCodeUsesExists(): void
    {
        ...
        preg_match_all('/plugins\.generic\.authorContributorEditor\.[a-zA-Z0-9_.]*[a-zA-Z0-9_]/', $sources, $m);
